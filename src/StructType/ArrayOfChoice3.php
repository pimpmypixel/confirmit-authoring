...
/**
 * This class stands for ArrayOfChoice3 StructType
 * @subpackage Structs
 */
class ArrayOfChoice3 extends AbstractStructBase
{
    /**
     * The HeaderAnswer
    ...
    public $Answer;
    /**
     * Constructor method for ArrayOfChoice3
     * @uses ArrayOfChoice3::setHeaderAnswer()
     * @uses ArrayOfChoice3::setHeaderAnswerEnd()
     * @uses ArrayOfChoice3::setLoopLevelReference()
     * @uses ArrayOfChoice3::setPredefined()
     * @uses ArrayOfChoice3::setAnswer()
     ...
     * @param \Confirmit\Authoring\StructType\HeaderAnswer $headerAnswer
     * @return \Confirmit\Authoring\StructType\ArrayOfChoice3
     */
