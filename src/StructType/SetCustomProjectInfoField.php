...
/**
 * This class stands for SetCustomProjectInfoField StructType
 * @subpackage Structs
 */
class SetCustomProjectInfoField extends AbstractStructBase
{
    /**
     * The key
    ...
    public $fieldValue;
    /**
     * Constructor method for SetCustomProjectInfoField
     * @uses SetCustomProjectInfoField::setKey()
     * @uses SetCustomProjectInfoField::setProjectId()
     * @uses SetCustomProjectInfoField::setFieldId()
     * @uses SetCustomProjectInfoField::setFieldValue()
     * @param string $key
     * @param string $projectId
     * @param string $fieldId
     * @param string $fieldValue
     */
    public function __construct($key = null, $projectId = null, $fieldId = null, $fieldValue = null)
    {
        $this
            ->setKey($key)
     ...
     * Set key value
     * @param string $key
     * @return \Confirmit\Authoring\StructType\SetCustomProjectInfoField
     */
