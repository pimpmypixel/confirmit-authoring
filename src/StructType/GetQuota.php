...
/**
 * This class stands for GetQuota StructType
 * @subpackage Structs
 */
class GetQuota extends AbstractStructBase
{
    /**
     * The projectSpecific
    ...
    public $name;
    /**
     * Constructor method for GetQuota
     * @uses GetQuota::setProjectSpecific()
     * @uses GetQuota::setKey()
     * @uses GetQuota::setProjectId()
     * @uses GetQuota::setName()
     * @param bool $projectSpecific
     * @param string $key
     * @param string $projectId
     * @param string $name
     */
    public function __construct($projectSpecific = null, $key = null, $projectId = null, $name = null)
    {
        $this
     ...
     * @param bool $projectSpecific
     * @return \Confirmit\Authoring\StructType\GetQuota
     */
