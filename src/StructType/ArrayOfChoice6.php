...
class ArrayOfChoice6 extends AbstractStructBase
{
     ...
     * @uses ArrayOfChoice6::setHeaderAnswer()
     * @uses ArrayOfChoice6::setHeaderAnswerEnd()
     * @uses ArrayOfChoice6::setLoopLevelReference()
     * @uses ArrayOfChoice6::setPredefined()
     * @uses ArrayOfChoice6::setAnswer()
     ...
     * @param \Confirmit\Authoring\StructType\HeaderAnswer $headerAnswer
     * @return \Confirmit\Authoring\StructType\ArrayOfChoice6
     */
