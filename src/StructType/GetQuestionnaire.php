...
/**
 * This class stands for GetQuestionnaire StructType
 * @subpackage Structs
 */
class GetQuestionnaire extends AbstractStructBase
{
    /**
     * The projectSpecific
    ...
    public $projectId;
    /**
     * Constructor method for GetQuestionnaire
     * @uses GetQuestionnaire::setProjectSpecific()
     * @uses GetQuestionnaire::setKey()
     * @uses GetQuestionnaire::setProjectId()
     ...
     * @param bool $projectSpecific
     * @return \Confirmit\Authoring\StructType\GetQuestionnaire
     */
